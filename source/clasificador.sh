...
/home/franco/Repos/ith-tp2/opensmile-2.0-rc1/opensmile/SMILExtract -C Configs/IS10_paraling.conf -I "$arch" -O processing/out.arff -instname replaceHere -noconsoleoutput 1 -logfile processing/log -appendLogfile 1 >> processing/log
