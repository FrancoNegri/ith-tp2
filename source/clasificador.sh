...
rm out.arff
rm inp.arff
~/Repos/ith-tp2/opensmile-2.0-rc1/opensmile/SMILExtract -C ~/Repos/ith-tp2/opensmile-2.0-rc1/opensmile/config/IS10_paraling.conf -I "$arch" -O out.arff -instname m
...
java -cp /usr/share/java/weka.jar weka.classifiers.lazy.IB1 -l 123.model -T inp.arff -p 0